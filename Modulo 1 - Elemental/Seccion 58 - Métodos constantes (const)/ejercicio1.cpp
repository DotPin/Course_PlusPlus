...
imprimir y un método llamado iguales que le llegue como parámetro la 
referencia de otra lista y retorne true o false. Definir el parámetro 
del método iguales de tipo const. Especificar que los métodos imprimir 
e iguales son constantes.*/
